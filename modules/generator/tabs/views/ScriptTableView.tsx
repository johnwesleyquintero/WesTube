                ...
                <td className="px-5 py-5 text-slate-300 text-xs align-top relative">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 space-y-3 relative group/edit">
                      {isInputingVisual ? (
                         <div className="bg-wes-900/90 p-2 rounded border border-wes-accent/30 animate-fadeIn">
                            <input 
                              autoFocus
                              className="w-full bg-transparent text-white outline-none placeholder-slate-500 mb-2"
                            ...
                            <div className="flex gap-2">
                               <button onClick={cancelRefinement} className="px-2 py-1 text-[10px] bg-white/10 rounded hover:bg-white/20">Cancel</button>
                               <button onClick={submitRefinement} className="px-2 py-1 text-[10px] bg-wes-accent text-white rounded hover:bg-wes-accent/80 font-bold">Apply</button>
                            </div>
                         </div>
                      ) : (
                        <div className="relative">
                          <textarea 
                            ...
                            className={`w-full bg-transparent text-slate-300 text-xs leading-relaxed resize-none outline-none focus:bg-black/20 focus:p-2 focus:rounded rounded -ml-2 p-2 border border-transparent focus:border-wes-accent/30 transition-all placeholder-slate-600 ${isRefiningVisual ? 'opacity-50 blur-sm' : ''}`}
                            rows={3}
                    ...
                    {isInputingAudio ? (
                      ...
                      <div className="relative">
                        <textarea 
                            ...
                            className={`w-full bg-transparent text-slate-200 font-light leading-relaxed resize-none outline-none focus:bg-black/20 focus:p-2 focus:rounded rounded -ml-2 p-2 border border-transparent focus:border-wes-accent/30 transition-all ${isRefiningAudio ? 'opacity-50 blur-sm' : ''}`}
                            rows={4}
                        />
                        {/* Magic Wand Trigger */}
