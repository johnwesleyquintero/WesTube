    ...
    <div className="h-full flex flex-col gap-8 overflow-y-auto custom-scrollbar animate-fadeIn">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end gap-4">
        ...
        <div className="flex items-center gap-3">
           <div className="px-4 py-2 bg-wes-900/50 border border-white/5 rounded-lg text-xs">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
         ...
         <div className="glass-panel p-6 rounded-xl border border-white/5 relative overflow-hidden group">
            ...
            <div className="text-2xl font-bold text-white truncate pr-8">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
           <button 
             ...
             className="group glass-panel p-6 rounded-xl text-left border border-white/5 hover:border-wes-accent/50 hover:bg-wes-accent/5 transition-all relative overflow-hidden"
           >
              ...
              <div className="relative z-10">
                 ...
                 <h3 className="text-white font-bold mb-1">New Script</h3>
           ...
           <button 
             ...
             className="group glass-panel p-6 rounded-xl text-left border border-white/5 hover:border-wes-pop/50 hover:bg-wes-pop/5 transition-all relative overflow-hidden"
           >
              ...
              <div className="relative z-10">
                 ...
                 <h3 className="text-white font-bold mb-1">Neural Brainstorm</h3>
           ...
           <button 
             ...
             className="group glass-panel p-6 rounded-xl text-left border border-white/5 hover:border-red-500/50 hover:bg-red-500/5 transition-all relative overflow-hidden"
           >
              ...
              <div className="relative z-10">
                 ...
                 <h3 className="text-white font-bold mb-1">Veo Studio</h3>
      ...
      <div className="flex-1">
        <div className="flex justify-between items-center mb-4">
           ...
           <button 
             ...
             className="text-xs text-wes-accent hover:text-white transition-colors"
           >
        ...
        <div className="space-y-3">
           {isLoading ? (
              <div className="flex flex-col gap-3">
                 {[1,2,3].map(i => (
                    <div key={i} className="h-20 bg-wes-900/30 rounded-xl animate-pulse"></div>
                 ))}
              </div>
              ...
              recentProjects.map((project) => {
                 ...
                 return (
                    <div 
                      key={project.id}
                      onClick={() => onNavigate('history')}
                      className="glass-panel p-4 rounded-xl flex items-center gap-4 hover:bg-white/5 transition-colors cursor-pointer group border-l-4 border-l-transparent hover:border-l-wes-accent"
                    >
                       ...
                       <div className="flex-1 min-w-0">
                          <h4 className="text-sm font-bold text-white truncate group-hover:text-wes-accent transition-colors">
                             {project.title}
                          </h4>
                       ...
                       <div className="text-right hidden sm:block">
                          <span className="text-[10px] bg-wes-900 border border-white/10 px-2 py-1 rounded text-slate-400">
                             {project.script.length} Scenes
                          </span>
                       </div>
                       <i className="fa-solid fa-chevron-right text-slate-600 text-xs group-hover:translate-x-1 transition-transform"></i>
                    </div>
                 );
              })
           )}
